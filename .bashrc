...
# $ 
alias downloads='cd ~/Downloads && PS1=\\u@\\h\ \\w\\n\\$\'

# Same but documents
alias documents='cd ~/Documents && PS1=\\u@\\h\ \\w\\n\\$\'

# shorten prompt anywhere
alias shorten='PS1=\\u@\\h\ \\w\\n\\$\'
...
forget_bot () {
  ...
  ssh-keygen -f "/home/user/.ssh/known_hosts" -R robot-ph-cpe$1
  ssh-keygen -f "/home/user/.ssh/known_hosts" -R $ip
